...
local Window = l:CreateWindow({
    Title = "North Hub - Plants vs Brainrots",
    Author = "North Hub",
...
local Discord = Window:Tab({Title = "Discord", Icon = "message-circle"})
...
-- Discord Tab
Discord:Section({Title = "Join Our Discord", Icon = "message-circle"})

Discord:Button({
    Title = "Copy Discord Link",
    Description = "Click to copy our Discord server link",
    Callback = function()
        if setclipboard then
            setclipboard("https://discord.gg/83kPyNANP")
            l:Notify({
                Title = "Success",
            ...
            l:Notify({
                Title = "Error",
                Description = "Your exploit doesn't support clipboard functions. Manual copy: https://discord.gg/83kPyNANP",
                Duration = 5
            })
        end
    end
...
Discord:Label({
    ...
    Description = "https://discord.gg/83kPyNANP"
})
...
-- Notify loaded
l:Notify({
    Title = "North Hub Loaded!",
    Description = "Plants vs Brainrots script loaded! North Hub",
    Duration = 3
})
